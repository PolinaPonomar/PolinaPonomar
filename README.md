...
<li>Прохожу курс по веб-разработке от <a href="https://praktikum.yandex.ru/">Я.Практикума</a></li>
<li>На данный момент заканчиваю работу над проектом Mesto👩‍💻 У него есть несколько версий, которые можно найти у меня в репозиториях</li>
